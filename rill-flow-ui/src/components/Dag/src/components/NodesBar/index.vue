  ...
  <div class="context px-1" v-if="nodes">
    <a-tabs v-model:activeKey="activeKey">
      <a-tab-pane key="1" tab="流程节点">
        <div class="tab-pane px-4 py-2" v-for="(node, index) in nodeList().function" :key="index"
            @mousedown="startDrag(
            {
              label: node.category,
              shape: 'rect',
        ...
        <div class="tab-pane  px-4 py-2" v-for="(node, index) in nodeList().plugin" :key="index"
             @mousedown="startDrag(
            {
        ...
        >
          <!--        {{node}}-->
          <NodeTemplate :label="node.node_type === 'meta' ? node.category : node.name"
                        :icon="node.icon"/>
        </div>
      </a-tab-pane>
...
<!--        </div>-->
    ...
    <!--    <ul class="nodes-bar">-->
    <!--      <li v-for="(node, index) in nodes" :key="index" class="node h-10">-->
    <!--        <div-->
...
<!--    <ul class="nodes-bar">-->
<!--      &lt;!&ndash; Vue组件 &ndash;&gt;-->
<!--      <li v-for="(node, index) in nodeList().function" :key="index"-->
<!--          @mousedown="startDrag(-->
<!--            {-->
<!--              label: node.category,-->
<!--              shape: 'rect',-->
...
<!--      <li v-for="(node, index) in nodeList().plugin" :key="index"-->
<!--          @mousedown="startDrag(-->
<!--            {-->
<!--              label: node.node_type === 'meta' ? node.category : node.name,-->
<!--              shape: 'rect',-->
...
<!--      &lt;!&ndash;    "&ndash;&gt;-->
<!--      &lt;!&ndash;      >&ndash;&gt;-->
<!--      &lt;!&ndash;        <NodeTemplate   label="xxx" icon1="data:image/jpeg;base64,"/>&ndash;&gt;-->
<!--      &lt;!&ndash;      </li>&ndash;&gt;-->
<!--    </ul>-->
...
import {getDiamondNode, getEllipseNode, getRectNode, getVueNode} from "@/components/Dag/src/common/transform";
