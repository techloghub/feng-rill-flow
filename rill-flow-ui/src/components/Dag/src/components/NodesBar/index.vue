<template>
  ...
  <div class="context px-8" v-if="nodes">
    <!--    <ul class="nodes-bar">-->
    ...
    <ul class="nodes-bar">
      ...
      <!-- Vue组件 -->
<!--      <li v-for="(node, index) in nodes[0].operatorList" :key="index"-->
<!--          @mousedown="startDrag(-->
<!--            {-->
<!--              label: node.category,-->
<!--              shape: 'rect',-->
...
<!--      </li>-->
      ...
      <!--    "-->
      <!--      >-->
      <!--        <NodeTemplate   label="xxx" icon1="data:image/jpeg;base64,"/>-->
      <!--      </li>-->
    </ul>
  </div>
